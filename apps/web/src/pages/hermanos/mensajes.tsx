  ...
  return (
    <div className="flex flex-col h-screen bg-gray-100">
      ...
      <main className="flex-1 p-6">
        <p className="text-lg text-black">Aquí se mostrará un listado completo de los mensajes enviados a los hermanos.</p>
        {/* Placeholder de tabla */}
        <div className="mt-4 bg-white text-black rounded shadow p-4">
          <p>Próximamente se mostrará una tabla con datos de los mensajes.</p>
        </div>
        <TablePlaceholder />
      </main>
    </div>
